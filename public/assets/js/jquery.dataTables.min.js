...
b[2].toLowerCase()),d[c]=e,"o"===b[1]&&E(a[e]))});a._hungarianMap=d}function P(a,b,c){a._hungarianMap||E(a);var d;l.each(b,function(e,h){d=a._hungarianMap[e];d===q||!c&&b[d]!==q||("o"===d.charAt(0)?(b[d]||(b[d]={}),l.extend(!0,b[d],b[e]),P(a[d],b[d],c)):b[d]=b[e])})}function ma(a){var b=u.defaults.oLanguage,c=b.sDecimal;c&&Wa(c);if(a){var d=a.sZeroRecords;!a.sEmptyTable&&d&&"Нет данных"===b.sEmptyTable&&X(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&d&&"Loading..."===b.sLoadingRecords&&
...
fnStateLoadParams:null,fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"В начало",sLast:"В конец",
sNext:"Следующая",sPrevious:"Предыдущая"},sEmptyTable:"Нет данных",sInfo:"Показано _START_ - _END_ строк из _TOTAL_",sInfoEmpty:"Показно 0 строк",sInfoFiltered:"(поиск по всем срокам)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Количество строк: _MENU_",sLoadingRecords:"Загрузка...",sProcessing:"Загрузка...",sSearch:"Поиск:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Данные отсутствуют"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",
