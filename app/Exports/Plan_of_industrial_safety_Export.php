...
class Plan_of_industrial_safety_Export implements FromView, WithStyles, ShouldAutoSize
{
    private $title, $data;
    ...
    {
        return view('web.docs.reports.excel_forms.excel_plan_of_industrial_safety', [
            'data' => $this->data,
            'title' => $this->title
        ]);
    }
