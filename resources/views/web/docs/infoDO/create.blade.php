...
@section('content')
            ...
            <div class="col-md-12" style="height: 100%">
                <div class="card" style="height: 100%">
                    <div class="card-header">
                        <h2 class="text-muted" style="text-align: center">Добавление записи в справочник филиалов ДО
                        </h2>
                    </div>
    ...
    <script>
        function save() {
            ...
            var params = ['short_name_do', 'full_name_do', 'guid_do']
            var out_data = []
            for (var param of params) {
                out_data[param] = document.getElementById(param).value
            }
            $.ajax({
                url: '/docs/directory_do/save',
                type: 'POST',
