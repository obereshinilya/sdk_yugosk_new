...
@section('content')
                        ...
                        <div style="background: #FFFFFF; border-radius: 6px" class="form51">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 0px"><select disabled id="id_do" style="height: 100%; width: 70%"
                                                                     class="select-css">
                                            <option
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 0px"><select disabled id="type_opo" style="height: 100%; width: 70%"
                                                                     class="select-css">
                                            <option
    ...
    <script>
        function update() {
            ...
            $.ajax({
                url: '/docs/directory_opo/update/{{$data->id_opo}}',
                type: 'POST',
