            ...
            <div class="col-md-12" style="height: 100%">
                <div class="card" style="height: 100%">
                    <div class="card-header">
                        <h2 class="text-muted" style="text-align: center">Добавление темы противоварийной тренировки
                        </h2>
                    </div>
                    <div class="inside_tab_padding form51"
                        ...
                        <div style="background: #FFFFFF; border-radius: 6px" class="form51">
                            <table>
                                ...
                                <tbody>
                                <tr>
                                    <th style="text-align: center">Наименование темы</th>
                                    <td style="padding: 0px">
                                        <input type="text" id="pat_desc" class="text-field__input" style="width: 95%">
                                    </td>
                                </tr>
                            ...
                            <div style="text-align: center">
                                ...
                                <div class="bat_add"
                                     style="width: 10%; display: inline-block; margin-top: 20px; margin-bottom: 20px; margin-left: 0px">
                                    <a style="background-color: #CD5C5C" href="/docs/pat_themes">Отменить</a>
                                </div>
                            </div>
                        </div>
                    </div>
