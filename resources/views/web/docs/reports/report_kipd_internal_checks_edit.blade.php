            ...
            <div class="col-md-12" style="height: 100%">
                <div class="card" style="height: 100%">
                    <div class="card-header">
                        <h2 class="text-muted" style="text-align: center">Редактирование записи в плане корректирующих
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 0px"><input id="podrazdelenie" type="text"
                                                                    ...
                                                                    value="{{$edition_data->podrazdelenie}}">
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 0px"><input id="error_comment" type="text"
                                                                    style="height: 100%; width: 95%"
                                                                    class="text-field__input"
                                                                    value="{{$edition_data->error_comment}}">
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 0px"><input id="correct_event" type="text"
                                                                    style="height: 100%; width: 95%"
                                                                    class="text-field__input"
                                                                    value="{{$edition_data->correct_event}}">
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 0px"><input id="person_correct" type="text"
                                                                    style="height: 100%; width: 95%"
                                                                    class="text-field__input"
                                                                    value="{{$edition_data->person_correct}}">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="padding: 0px"><input id="date_check_correct" type="date"
                                                                    style="height: 100%; width: 95%"
                                                                    class="text-field__input"
                                                                    value="{{$edition_data->date_check_correct}}">
                                    </td>
                                </tr>
                                </tbody>
                            </table>
