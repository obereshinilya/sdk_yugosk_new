...
<table style="border-collapse: collapse;" class="table table-hover">
        ...
        <tr>
            ...
            <td style="text-align: center; border-bottom: 1px solid white">Капитальный ремонт</td>
        ...
        <tr>
            ...
            <td style="text-align: center; border-bottom: 1px solid white" ></td>
        ...
        <tr>
            ...
            <td style="text-align: center; border-bottom: 0px solid black" >Капитальный ремонт, капитальное строительство и реконструкция </td>
