...
@section('content')
            ...
            <div class="col-md-12" style="height: 100%">
                <div class="card" style="height: 100%">
                    <div class="card-header">
                        <h2 class="text-muted" style="text-align: center">Добавление записи в реестр актуальных
                        ...
                        <div style="background: #FFFFFF; border-radius: 6px" class="form51">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 0px"><textarea id="reg_num_dpb" style="height: 100%; width: 95%"
                                                                       class="text-field__input"></textarea></td>
                                </tr>
                                <tr>
                                    <th style="text-align: center">Рег. № ДПБ в Ростехнадзоре</th>
                                    <td style="padding: 0px"><textarea id="name_zepb" style="height: 100%; width: 95%"
                                                                       class="text-field__input"></textarea></td>
                                </tr>
                                <tr>
    ...
    <script>
        ...
        function save() {
            ...
            $.ajax({
                url: '/docs/actual_declarations/save',
                type: 'POST',
