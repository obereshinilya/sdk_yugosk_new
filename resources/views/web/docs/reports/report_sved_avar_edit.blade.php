                        ...
                        <div style="background: #FFFFFF; border-radius: 6px" class="form51">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 0px"><select disabled id="naim_filiala" style="height: 100%; width: 50%"
                                                                     class="select-css">
                                                <option value="{{$data->naim_filiala}}">{{$data->naim_filiala}}</option>
                                        </select></td>
                                </tr>
                                <tr>
...
{{--                                                                    class="text-field__input"></td>--}}
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 0px"><input type="text" id="mesto_techno_sob" value="{{$data->mesto_techno_sob}}"
                                                                    style="height: 100%; width: 95%"
                                                                    class="text-field__input"></td>
                                </tr>
                                <tr>
                                    <th style="text-align: center">Дата и время техногенного события (МСК)</th>
                                    <td style="padding: 0px"><input type="text" id="data_time" value="{{$data->data_time}}"
                                                                    style="height: 100%; width: 95%"
                                                                    class="text-field__input"></td>
                                </tr>
                                <tr>
...
{{--                                                                    class="text-field__input"></td>--}}
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 0px"><input type="text" id="kratk_opisan" value="{{$data->kratk_opisan}}"
                                                                    style="height: 100%; width: 95%"
                                                                    class="text-field__input"></td>
                                </tr>
                                <tr>
                                    <th style="text-align: center">Наличие пострадавших</th>
                                    <td style="padding: 0px"><input type="text" id="nalich_postradav" value="{{$data->nalich_postradav}}"
                                                                    style="height: 100%; width: 95%"
                                                                    class="text-field__input"></td>
                                </tr>
                                <tr>
                                    <th style="text-align: center">Экономический ущерб от аварии, тыс. руб.</th>
                                    <td style="padding: 0px"><input type="text" id="econom_usherb" value="{{$data->econom_usherb}}"
                                                                    style="height: 100%; width: 95%"
                                                                    class="text-field__input"></td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="padding: 0px"><input type="text" id="prodolgit_prost" value="{{$data->prodolgit_prost}}"
                                                                    style="height: 100%; width: 95%"
                                                                    class="text-field__input"></td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="padding: 0px"><input type="text" id="litsa_otvetstven" value="{{$data->litsa_otvetstven}}"
                                                                    style="height: 100%; width: 95%"
                                                                    class="text-field__input"></td>
                                </tr>
                                <tr>
...
{{--                                                                    class="text-field__input"></td>--}}
                                    <td style="padding: 0px"><textarea id="meropriytia"
                                                                       style="height: 100%; width: 95%"
                                                                       class="text-field__input">{{$data->meropriytia}}</textarea></td>
                                </tr>
                                <tr>
