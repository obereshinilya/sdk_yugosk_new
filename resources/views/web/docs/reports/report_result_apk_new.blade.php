            ...
            <div class="col-md-12" style="height: 100%">
                <div class="card" style="height: 100%">
                    <div class="card-header">
                        <h2 class="text-muted" style="text-align: center">Добавление записи в результаты АПК, корпоративного контроля и государственного надзора</h2>
                    </div>
                    ...
                    <div class="inside_tab_padding form51"
                        ...
                        <div style="background: #FFFFFF; border-radius: 6px" class="form51">
                            <table>
                                ...
                                <tr>
                                    <th id="">Факт</th>
                                    <td style="padding: 0px"><input id="level4_fact" type="number" min="0" step="1" style="height: 100%; width: 95%" class="text-field__input" value="">
                                    </td>
                                </tr>
                                <tr>
                                    <th id="" colspan="2">Количество выявленных нарушений</th>
