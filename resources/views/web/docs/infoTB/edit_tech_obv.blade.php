...
{{--                                </tr>--}}
                                ...
                                <tr>
                                    <th style="text-align: center">Температура после пылеуловителей (тег)</th>
                                    <td style="padding: 0px"><input id="tag_t_in" type="text"  style="height: 100%; width: 95%"
                                                                    class="text-field__input" value="{{$data_tb->tag_t_in}}">
                                    </td>
                                </tr>
                                <tr>
                                    <th style="text-align: center">Температура перед АВО (тег)</th>
    ...
    <script>
        ...
        function update() {
            ...
            var params = ['full_name_tb', 'short_name_tb', 'guid_tb', 'date_end', 'tag_t_in', 'tag_t_out', 'tag_p_in', 'tag_p_out', 'id_status', 'p_w', 'n', 'n_w', 'n_lim']
            var out_data = []
