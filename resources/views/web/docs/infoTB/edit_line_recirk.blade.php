...
{{--                                </tr>--}}
                                ...
                                <tr>
                                    <th style="text-align: center">Давление перед краном №8 (тег)</th>
                                ...
                                <tr>
                                    <th style="text-align: center">Температура после крана №7 МКУ (тег)</th>
                                    <td style="padding: 0px"><input id="tag_t_in" type="text"  style="height: 100%; width: 95%"
                                                                    class="text-field__input" value="{{$data_tb->tag_t_in}}">
                                    </td>
                                </tr>
                                <tr>
                                    <th style="text-align: center">Температура перед краном №8 (тег)</th>
    ...
    <script>
        ...
        function update() {
            ...
            var params = ['full_name_tb', 'short_name_tb', 'guid_tb', 'p_w', 'date_end', 'tag_t_in', 'tag_t_out', 'tag_p_in', 'tag_p_out', 'id_status', 'n', 'n_w', 'n_lim']
            var out_data = []
