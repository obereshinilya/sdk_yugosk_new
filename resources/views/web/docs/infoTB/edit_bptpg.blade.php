...
{{--                                </tr>--}}
    ...
    <script>
        ...
        function update() {
            ...
            var params = ['full_name_tb', 'short_name_tb', 'guid_tb', 'p_w', 'date_end', 'tag_t_in', 'tag_t_out', 'tag_p_in', 'tag_p_out', 'id_status']
            var out_data = []
