...
{{--                                </tr>--}}
                                ...
                                <tr>
                                    <th style="text-align: center">Расположение крана, км</th>
                                    <td style="padding: 0px"><input id="l_kran" type="number" step="0.01" style="height: 100%; width: 95%"
                                                                    class="text-field__input" value="{{$data_tb->l_kran}}">
                                    </td>
                                </tr>

{{--                                <tr>--}}
{{--                                    <th style="text-align: center">Максимальный перепад давления на кране, кгс/см2</th>--}}
{{--                                    <td style="padding: 0px"><input id="delta_p_max" type="number" step="0.01" style="height: 100%; width: 95%"--}}
{{--                                                                    class="text-field__input" value="{{$data_tb->delta_p_max}}">--}}
{{--                                    </td>--}}
{{--                                </tr>--}}
{{--                                <tr>--}}
{{--                                    <th style="text-align: center">Расчетная дата перехода в класс безопасности "Низкий"</th>--}}
...
{{--                                </tr>--}}
                                ...
                                <tr>
                                    <th style="text-align: center">Состояние крана (тег)</th>
    ...
    <script>
        ...
        function update() {
            ...
            var params = ['full_name_tb', 'short_name_tb', 'guid_tb', 'l_kran', 'tag_p_in', 'tag_p_out', 'status_kran']
            var out_data = []
