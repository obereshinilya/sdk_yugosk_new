...
@section('content')
                    ...
                    <div class="inside_tab_padding form51"
                        ...
                        <div style="background: #FFFFFF; border-radius: 6px" class="form51">
                            <table>
                                ...
                                <tr>
                                    <th style="text-align: center">Начало участка, км</th>
                                    <td style="padding: 0px"><input id="l_in" type="number" step="0.01" style="height: 100%; width: 95%"
                                                                    class="text-field__input" value="{{$data_tb->l_in}}">
                                    </td>
                                </tr>
                                <tr>
                                    <th style="text-align: center">Конец участка, км</th>
                                    <td style="padding: 0px"><input id="l_out" type="number" step="0.01" style="height: 100%; width: 95%"
                                                                    class="text-field__input" value="{{$data_tb->l_out}}">
                                    </td>
                                </tr>
                                <tr>
                                    <th style="text-align: center">Разрешенное рабочее давление (кгс/см2)</th>
                                    <td style="padding: 0px"><input id="p_project" type="number" step="0.01" style="height: 100%; width: 95%"
                                                                    class="text-field__input" value="{{$data_tb->p_project}}">
                                    </td>
                                </tr>
                                <tr>
                                    <th style="text-align: center">Расчетное давление по классу безопасности "Низкий", кгс/см2</th>
                                    <td style="padding: 0px"><input id="p_low" type="number" step="0.01" style="height: 100%; width: 95%"
                                                                    class="text-field__input" value="{{$data_tb->p_low}}">
                                    </td>
                                </tr>
                                <tr>
    ...
    <script>
        ...
        function update() {
            ...
            var params = ['full_name_tb', 'short_name_tb', 'guid_tb', 'l_in', 'l_out', 'p_project', 'p_low', 'time_low', 'date_end', 'tag_t_in', 'tag_t_out', 'tag_p_in', 'tag_p_out', 'id_status']
            var out_data = []
